...
import { Zap, Activity, MousePointerClick, Flame, Copy, Check } from 'lucide-react';
...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="p-1.5 rounded-md hover:bg-white/10 text-gray-500 hover:text-white transition-colors cursor-pointer flex items-center gap-1.5"
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <div className="md:col-span-8 bg-white rounded-[2rem] p-10 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-gray-100 relative overflow-hidden group hover:shadow-[0_20px_60px_rgba(0,0,0,0.12)] transition-shadow duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl opacity-70 leading-relaxed max-w-xl">Drop in our tiny script and instantly start capturing page views, clicks, and scroll depth across your entire web application. No complex tagging plans required.</p>
                ...
                <div className="mt-10 bg-[#0A0A0A] rounded-2xl w-full border border-gray-800 shadow-2xl transform group-hover:-translate-y-2 transition-transform duration-500 overflow-hidden relative">
                  ...
                  <div className="flex items-center justify-between px-4 py-3 bg-white/5 border-b border-white/5">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <CopyButton text={`<!-- Paste this snippet in your <head> -->\n<script>window.CF_CONFIG = { endpoint: 'https://open-trace.onrender.com' };</script>\n<script src="https://open-trace-kappa.vercel.app/tracker.js" defer></script>`} />
                    </div>
                  </div>
            ...
            <div className="bg-[#0A0A0A] rounded-3xl p-8 text-left max-w-2xl mx-auto mb-12 shadow-[0_20px_60px_rgba(0,0,0,0.4)] relative border border-white/10 group">
              ...
              <div className="flex items-center justify-between mb-6 border-b border-white/10 pb-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <CopyButton text={`<script>\n  window.CF_CONFIG = {\n    endpoint: 'https://open-trace.onrender.com'\n  };\n</script>\n<script src="https://open-trace-kappa.vercel.app/tracker.js" defer></script>`} />
                </div>
              </div>
